...
- **Stake** - May be required for voting power
- **Transfer** - For managing governance tokens

<Alert type="info">
Voting power is often proportional to token holdings. Check governance rules before voting.
</Alert>
